...
if (ENABLE_CPP_CHECK)
  ...
  if (CPP_CHECK)
    ...
    set(CMAKE_CXX_CPPCHECK
        ${CPP_CHECK} --project=${CMAKE_BINARY_DIR}/compile_commands.json --enable=all --inline-suppr --std=c++${CMAKE_CXX_STANDARD}
        --suppress=*:${CATKIN_DEVEL_PREFIX}/${CATKIN_GLOBAL_INCLUDE_DESTINATION}/ --suppress=*:/usr/src/googletest/)
  else ()
